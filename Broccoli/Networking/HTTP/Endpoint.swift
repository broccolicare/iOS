...
public enum BookingEndpoint: Endpoint {
    case availableTimeSlots(date: Date, isGP: String?, departmentId: String?)
    ...
    public var path: String {
        ...
        case .paymentInitialize:
            return "/bookings/payment-sheet/initialize"
        case .paymentConfirm:
            return "/bookings/payment-sheet/confirm"
        }
    }
    
    public var method: HTTPMethod {
        switch self {
        case .availableTimeSlots, .bookingDetails:
            return .GET
        case .createBooking, .uploadDocument, .paymentInitialize, .paymentConfirm:
            return .POST
        case .cancelBooking:
            return .PUT
        }
    ...
    public var queryItems: [String: String]? {
        switch self {
        case .availableTimeSlots(let date, let isGP, let departmentId):
