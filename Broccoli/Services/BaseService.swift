...
open class BaseService {
    ...
    func handleServiceError<T>(_ operation: () async throws -> T) async throws -> T {
        do {
    ...
    func handleServiceErrorVoid(_ operation: () async throws -> Void) async throws {
        let _: Void = try await handleServiceError(operation)
    }
}
